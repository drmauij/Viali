...
const pacuShortItems: PostopOrderItem[] = [
  ...
  { id: id(), type: 'task', title: 'Antibiotikum nach 4h wiederholen', timing: { mode: 'conditional', condition: 'falls AB gegeben' } },
  { id: id(), type: 'task', title: 'OSAS: Min. 4h Beobachtung nach letztem Opioid', timing: { mode: 'conditional', condition: 'bei OSAS-Patienten' } },
  { id: id(), type: 'task', title: 'Begleitperson für Entlassung erforderlich', timing: { mode: 'ad_hoc' } },
  { id: id(), type: 'task', title: 'Motorik-Check nach Regionalanästhesie', timing: { mode: 'ad_hoc' }, actionHint: 'Vor Entlassung Sensibilität und Motorik prüfen' },
  { id: id(), type: 'task', title: 'Verlängerte Überwachung (Risiko-Patient)', timing: { mode: 'ad_hoc' } },
  { id: id(), type: 'task', title: 'Keine oralen Antikoagulanzien für 24h', timing: { mode: 'conditional', condition: 'nach Regionalanästhesie' } },
...
const overnightItems: PostopOrderItem[] = [
  ...
  { id: id(), type: 'task', title: 'Wundkontrolle', timing: { mode: 'scheduled', frequency: 'q24h' } },
  { id: id(), type: 'task', title: 'Verbandwechsel bei Durchnässung', timing: { mode: 'ad_hoc' } },
];
