...
You must return a JSON object with exactly these fields:
{
  ...
  "content": "The cleaned body content of the document — strip all hospital headers, addresses, letterheads, page numbers, footers, and signature blocks. Keep only the medical brief content with section headings and paragraphs preserved."
}
