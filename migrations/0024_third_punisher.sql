...
ALTER TABLE "surgery_preop_assessments" ADD CONSTRAINT "surgery_preop_assessments_surgery_id_surgeries_id_fk" FOREIGN KEY ("surgery_id") REFERENCES "public"."surgeries"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_surgery_preop_assessments_surgery" ON "surgery_preop_assessments" USING btree ("surgery_id");