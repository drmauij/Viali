...
CREATE TABLE "inventory_usage" (
	...
	"anesthesia_record_id" varchar NOT NULL,
	"item_id" varchar NOT NULL,
	"calculated_qty" numeric(10, 2) DEFAULT '0' NOT NULL,
	"override_qty" numeric(10, 2),
...
CREATE TABLE "order_lines" (
	...
	"notes" text,
	"offline_worked" boolean DEFAULT false,
...
CREATE TABLE "preop_assessments" (
	...
	"consent_regional" boolean DEFAULT false,
	"consent_installations" boolean DEFAULT false,
	"consent_icu" boolean DEFAULT false,
	"consent_text" text,
	"consent_doctor_signature" text,
