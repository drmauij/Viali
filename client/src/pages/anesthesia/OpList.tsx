...
export default function OpList() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 pb-24">
      {/* POC / Development Banner */}
      <div className="mb-4 bg-amber-500 dark:bg-amber-600 text-white px-4 py-3 rounded-lg border-2 border-amber-600 dark:border-amber-700 shadow-lg">
        <div className="flex items-center gap-2 justify-center">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
          </svg>
          <span className="font-semibold text-sm sm:text-base">⚠️ POC / DEVELOPMENT MODULE - Not for Production Use</span>
        </div>
      </div>
