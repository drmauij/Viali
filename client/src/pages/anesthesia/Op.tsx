    ...
    <Dialog open={isOpen} onOpenChange={handleDialogChange}>
      <DialogContent className="max-w-full h-[100dvh] m-0 p-0 gap-0 flex flex-col [&>button]:hidden" aria-describedby="op-dialog-description">
        ...
        <Tabs defaultValue="vitals" className="flex-1 flex flex-col min-h-0">
          ...
          {/* Vitals & Timeline Tab */}
          <TabsContent value="vitals" className="flex-1 overflow-hidden mt-2 flex flex-col">
          ...
          <TabsContent value="anesthesia" className="flex-1 overflow-y-auto px-6 pb-6 mt-2">
            <Card>
              <CardHeader>
          ...
          {/* WHO Checklists Tab */}
          <TabsContent value="checklists" className="flex-1 overflow-y-auto px-6 pb-6 mt-2 space-y-4">
            {/* Sign-In Checklist */}
            <Card>
              <CardHeader>
          ...
          <TabsContent value="postop" className="flex-1 overflow-y-auto px-6 pb-6 mt-2">
            <Card>
              <CardHeader>
