...
export function UnifiedTimeline({
  ...
  const option = useMemo(() => {
    ...
    const medicationColor = isDark ? "rgba(52, 211, 153, 0.25)" : "rgba(220, 252, 231, 0.8)";
    ...
    const grids = [
      ...
      { left: 150, right: 10, top: 380, height: 50, backgroundColor: isDark ? "rgba(168, 85, 247, 0.25)" : "rgba(243, 232, 255, 0.8)" },
      // Grid 2: Events (blue background)
      { left: 150, right: 10, top: 430, height: 40, backgroundColor: isDark ? "rgba(59, 130, 246, 0.25)" : "rgba(219, 234, 254, 0.8)" },
      // Grid 3: Heart Rhythm (pink background)
      { left: 150, right: 10, top: 470, height: 40, backgroundColor: isDark ? "rgba(236, 72, 153, 0.25)" : "rgba(252, 231, 243, 0.8)" },
      ...
      { left: 150, right: 10, top: medicationEnd, height: 40, backgroundColor: isDark ? "rgba(6, 182, 212, 0.25)" : "rgba(207, 250, 254, 0.8)" },
      // Ventilation (amber background)
      { left: 150, right: 10, top: medicationEnd + 40, height: 40, backgroundColor: isDark ? "rgba(245, 158, 11, 0.25)" : "rgba(254, 243, 199, 0.8)" },
      // Staff (slate background)
      { left: 150, right: 10, top: medicationEnd + 80, height: 40, backgroundColor: isDark ? "rgba(148, 163, 184, 0.25)" : "rgba(241, 245, 249, 0.8)" },
    ];
  ...
  return (
    <div className="w-full h-full relative" style={{ height: componentHeight }}>
      ...
      <div className="absolute left-0 top-0 right-0 h-full pointer-events-none z-0">
        {/* Times background */}
        <div className="absolute top-[380px] h-[50px] w-full" style={{ backgroundColor: isDark ? "rgba(168, 85, 247, 0.25)" : "rgba(243, 232, 255, 0.8)" }} />
        {/* Events background */}
        <div className="absolute top-[430px] h-[40px] w-full" style={{ backgroundColor: isDark ? "rgba(59, 130, 246, 0.25)" : "rgba(219, 234, 254, 0.8)" }} />
        {/* Heart Rhythm background */}
        <div className="absolute top-[470px] h-[40px] w-full" style={{ backgroundColor: isDark ? "rgba(236, 72, 153, 0.25)" : "rgba(252, 231, 243, 0.8)" }} />
        ...
        <div 
          ...
          style={{ 
            ...
            backgroundColor: isDark ? "rgba(148, 163, 184, 0.25)" : "rgba(241, 245, 249, 0.8)" 
          }} 
        />
      </div>
