...
export function UnifiedTimeline({
  ...
  const option = useMemo(() => {
    ...
    const yAxes = [
      // Vitals grid - First y-axis (BP/HR: 0 to 240 range for top and bottom padding, showing 0-220 labels)
      {
        type: "value" as const,
        gridIndex: 0,
        min: 0,
    ...
    // First y-axis (0-220, interval 20) - positioned at x=70px, grid extends 0 to 240 for top and bottom padding
    ...
    <div className="w-full relative" style={{ height: componentHeight }}>
      ...
      <div className="absolute left-0 top-0 w-[150px] h-full border-r border-border z-30 bg-background">
        ...
        <div className="absolute top-[32px] h-[340px] w-full pointer-events-none z-50">
          {/* First scale: 0-220 with 20-unit steps (11 values) - close to grid, grid extends 0 to 240 for top and bottom padding */}
