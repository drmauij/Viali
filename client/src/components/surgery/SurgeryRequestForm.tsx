                  ...
                  {ambulantEligibilityEnabled && (
                    <div className="space-y-2 md:col-span-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="minor">{ti18n('ambulantEligibility.riskClass.minor', 'Minor (e.g. skin lesion excision, simple suture, port placement)')}</SelectItem>
                          <SelectItem value="standard">{ti18n('ambulantEligibility.riskClass.standard', 'Standard (e.g. hernia repair, arthroscopy, varicose veins)')}</SelectItem>
                          <SelectItem value="large">{ti18n('ambulantEligibility.riskClass.large', 'Large (e.g. joint replacement, mastopexy, large hernia)')}</SelectItem>
